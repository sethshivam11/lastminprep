    ...
    <div className="z-50 sticky top-0 w-full bg-white/50 dark:bg-black/50 backdrop-blur-sm border-b border-stone-200 dark:border-stone-800 ">
      <div className="flex justify-between items-center sm:px-10 px-2 py-2 max-w-7xl mx-auto">
        <Drawer>
          <DrawerTrigger asChild>
            <Button
              variant="outline"
              size="icon"
              className={`sm:hidden ${location.includes("/appearing") ? "hidden" : ""
                }`}
            >
              <Menu />
            </Button>
        ...
        <Link
          ...
          className={`font-extrabold text-lg tracking-tight flex gap-2 items-center justify-center ${location.includes("appearing") ? "max-sm:w-full" : ""
            }`}
        >
        ...
        <div
          className={`sm:flex hidden gap-5 items-center justify-between ${location.includes("/appearing") ? "sm:hidden" : ""
            }`}
        >
